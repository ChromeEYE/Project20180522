...
<body class="body">
    ...
    <p>性別 
        ...
        <span>不明<input type="radio" name="gender" value="0" runat="server"/>
    ...
    <p>生年月日 <span>年<asp:TextBox ID="birth_y" runat="server"></asp:TextBox>
        月<asp:TextBox ID="birth_m" runat="server"></asp:TextBox>
        日<asp:TextBox ID="birth_d" runat="server"></asp:TextBox></span>
   </p>

    <p>所属部署<span><select name="section">
